...
class ExampleWidget9 extends StatelessWidget {
  const ExampleWidget9({super.key});
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            const _ThreeWidget(),
            const _FourWidget(),
            //похож на Consumer, но значение усекается с помощью селектора
            // selector более точечный
            Selector<Model, int>(
