...
class ExampleWidget4 extends StatefulWidget {
  const ExampleWidget4({super.key});

  @override
  State<ExampleWidget4> createState() => _ExampleWidget4State();
}

class _ExampleWidget4State extends State<ExampleWidget4> {
...
//получить конкретное значение модели + подписаться только на значения этого параметра
    ...
    final state = context.read<_ExampleWidget4State>();
    return Scaffold(
      body: SafeArea(
        child: Column(
          children: [
